...
========================================= */
const CornerBouquet = ({ className }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M0 0 Q100 50 180 180" stroke="#a7f3d0" strokeWidth="2" fill="none"/>
    <path d="M0 0 Q50 120 120 200" stroke="#a7f3d0" strokeWidth="2" fill="none"/>
    <path d="M0 0 Q150 20 200 120" stroke="#a7f3d0" strokeWidth="2" fill="none"/>
    <path d="M40 20 Q60 0 80 30 Q50 50 40 20" fill="#d1fae5" />
    <path d="M80 60 Q110 40 120 80 Q90 100 80 60" fill="#d1fae5" />
    <path d="M20 70 Q40 50 50 90 Q20 100 20 70" fill="#a7f3d0" />
    <path d="M50 120 Q80 100 90 140 Q60 150 50 120" fill="#a7f3d0" />
    <path d="M120 20 Q150 0 160 40 Q130 50 120 20" fill="#d1fae5" />
    <circle cx="60" cy="60" r="30" fill="#ffe4e6"/>
    <circle cx="55" cy="55" r="20" fill="#fecdd3"/>
    <circle cx="50" cy="50" r="10" fill="#fda4af"/>
    <circle cx="110" cy="110" r="25" fill="#fecdd3"/>
    <circle cx="105" cy="105" r="15" fill="#fda4af"/>
    <circle cx="100" cy="100" r="8" fill="#fb7185"/>
    <circle cx="30" cy="110" r="15" fill="#ffe4e6"/>
    <circle cx="25" cy="105" r="8" fill="#fecdd3"/>
    <circle cx="130" cy="60" r="18" fill="#fecdd3"/>
    <circle cx="125" cy="55" r="10" fill="#fda4af"/>
    <circle cx="160" cy="100" r="12" fill="#ffe4e6"/>
    <circle cx="155" cy="95" r="6" fill="#fecdd3"/>
  </svg>
);
...
const FloralFrame = () => (
  <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
    <CornerBouquet className="absolute -top-12 -left-12 w-64 h-64 md:w-96 md:h-96 opacity-90 drop-shadow-lg" />
    <CornerBouquet className="absolute -top-12 -right-12 w-64 h-64 md:w-96 md:h-96 opacity-90 rotate-90 drop-shadow-lg" />
    <CornerBouquet className="absolute -bottom-12 -left-12 w-64 h-64 md:w-96 md:h-96 opacity-90 -rotate-90 drop-shadow-lg" />
    <CornerBouquet className="absolute -bottom-12 -right-12 w-64 h-64 md:w-96 md:h-96 opacity-90 rotate-180 drop-shadow-lg" />
    ...
    <div className="relative z-50">
      <div className={`env-wrapper cursor-pointer group ${isShaking ? 'wiggle-anim' : ''}`} onClick={onOpen}>
        ...
        <div className={`absolute bottom-[-15px] left-0 w-full flex justify-between items-end pointer-events-none px-2 sm:px-10 z-30 transition-all duration-1000 ${(isOpening && !isShaking) ? 'opacity-0 translate-y-32' : 'opacity-100 translate-y-0'}`}>
           <Bouquet className="w-36 md:w-60 h-auto origin-bottom -rotate-12 translate-y-4 md:translate-y-8" />
           <Bouquet className="w-44 md:w-80 h-auto origin-bottom translate-y-2 md:translate-y-4 z-40" />
           <Bouquet className="w-36 md:w-60 h-auto origin-bottom rotate-12 translate-y-4 md:translate-y-8" />
        </div>
      </div>
    </div>
...
export default function EtherealBirthday() {
  ...
  const playlist = [
    ...
    { title: "Melodi Kita", artist: "Kenangan Pertama", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3" },
    { title: "Bintang Jatuh", artist: "Senja di Bulan Mei", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3" }
  ];
  ...
  */
  ...
  const memoriesGrid = [
    { id: 1, col: "col-span-2 md:col-span-2 row-span-2 md:row-span-2", img: "https://images.unsplash.com/photo-1490750967868-88cb4ecb07cb?auto=format&fit=crop&w=600&h=600&q=80" }, 
    { id: 2, col: "col-span-1 md:col-span-1 row-span-2 md:row-span-2", img: "https://images.unsplash.com/photo-1508610048659-a06b669e3321?auto=format&fit=crop&w=300&h=600&q=80" }, 
    { id: 3, col: "col-span-1 md:col-span-1 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1457089328109-e5d9bd499191?auto=format&fit=crop&w=300&h=300&q=80" }, 
    { id: 4, col: "col-span-1 md:col-span-1 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1468327768560-75b778cbb551?auto=format&fit=crop&w=300&h=300&q=80" }, 
    { id: 5, col: "col-span-2 md:col-span-2 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1526047932273-341f2a7631f9?auto=format&fit=crop&w=600&h=300&q=80" }, 
    { id: 6, col: "col-span-2 md:col-span-2 row-span-2 md:row-span-2", img: "https://images.unsplash.com/photo-1508536136154-159b38ec70c2?auto=format&fit=crop&w=600&h=600&q=80" }, 
    { id: 7, col: "col-span-1 md:col-span-1 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1562690868-60bbe7293e94?auto=format&fit=crop&w=300&h=300&q=80" }, 
    { id: 8, col: "col-span-1 md:col-span-1 row-span-2 md:row-span-2", img: "https://images.unsplash.com/photo-1503435824048-a799a3a84bf7?auto=format&fit=crop&w=300&h=600&q=80" }, 
    { id: 9, col: "col-span-1 md:col-span-1 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1470509037663-253afd7f0f51?auto=format&fit=crop&w=300&h=300&q=80" }, 
    { id: 10, col: "col-span-2 md:col-span-2 row-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1518895949257-7621c3c786d7?auto=format&fit=crop&w=600&h=300&q=80" }, 
  ];
        ...
        <div className="w-full relative z-20 animate-in fade-in duration-1000">
          ...
          <section className="py-10 px-6 flex justify-center items-center">
            <div className="reveal-zoom max-w-4xl w-full rounded-[2rem] overflow-hidden shadow-lg border-2 border-white/50 relative group">
              <img 
                src="https://images.unsplash.com/photo-1522748906645-95d8ad852445?auto=format&fit=crop&w=1200&q=80" 
                alt="Ethereal Beauty" 
          ...
          <section className="py-20 px-4 md:px-6 flex flex-col justify-center min-h-[70vh]">
            <h3 className="reveal text-3xl mb-12 md:mb-16 text-center text-stone-700 font-serif italic">Kenangan Manis</h3>
          ...
          <footer className="py-24 px-6 flex flex-col items-center justify-center text-center reveal">
            ...
            <div className="w-16 h-[1px] bg-rose-200 mb-6"></div>
